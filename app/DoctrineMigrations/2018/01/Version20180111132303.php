 ...
 */
class Version20180111132303 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'Подключите ДОСТУП до 31.01.2018 - получите БАННЕР БЕСПЛАТНО!', '2017-12-05 12:28:13',
              '2018-01-11 12:28:13', '2018-01-11 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_banner_gift_31_12_2018.html.twig')",
                array('newsletter_id' => 32),
