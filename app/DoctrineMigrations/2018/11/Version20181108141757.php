 ...
 */
class Version20181108141757 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'Подписка Телеграмм', '2018-11-07 12:28:13',
              '2018-11-07 12:28:13', '2018-11-07 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_telegram.html.twig')",
                array('newsletter_id' => 43),
