 ...
 */
class Version20181026165333 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'Черная Пятница: скидки 10%-20%-30% - бывшие', '2018-10-26 12:28:13',
              '2018-10-26 12:28:13', '2018-10-26 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_12_02_2018_discount_ex.html.twig')",
                array('newsletter_id' => 42),
