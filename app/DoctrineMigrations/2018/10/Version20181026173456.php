 ...
 */
class Version20181026173456 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'Черная Пятница: скидки 10%-20%-30% - потенциальные', '2018-10-26 12:28:13',
