 ...
 */
class Version20181227131604 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'С наступающим Новым Годом и Рождеством - Металлопрокат.ру!', '2018-12-27 12:28:13',
              '2018-12-27 12:28:13', '2018-12-27 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2019_card.html.twig')",
                array('newsletter_id' => 46),
