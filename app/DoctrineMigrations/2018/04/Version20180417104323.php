 ...
 */
class Version20180417104323 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'Не майся-подключайся!', '2018-04-17 12:28:13',
              '2018-04-17 12:28:13', '2018-04-17 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_may_discount.html.twig')",
                array('newsletter_id' => 35),
