 ...
 */
class Version20191023112140 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'Только в наябре - 25% скидка на Металлопрокат', '2019-10-25 12:28:13',
              '2019-10-25 12:28:13', '2019-10-25 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2019_hb_discount.html.twig')",
                array('newsletter_id' => 51),
