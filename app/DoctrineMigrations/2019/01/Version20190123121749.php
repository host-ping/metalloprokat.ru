 ...
 */
class Version20190123121749 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'НГ рассылка 2019 - финальная', '2019-01-23 12:28:13',
              '2019-01-23 12:28:13', '2019-01-23 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2018_new_year_discount.html.twig')",
                array('newsletter_id' => 48),
