 ...
 */
class Version20190809115606 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, '25% лето на Металлопрокат', '2019-08-09 12:28:13',
              '2019-08-09 12:28:13', '2019-08-09 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2019_hb_discount.html.twig')",
                array('newsletter_id' => 50),
