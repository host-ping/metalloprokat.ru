 ...
 */
class Version20191216135219 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'Новогодняя', '2019-12-162019-12-16 12:28:13',
              '2019-12-16 12:28:13', '2019-12-16 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2019_new_year_discount.html.twig')",
                array('newsletter_id' => 53),
