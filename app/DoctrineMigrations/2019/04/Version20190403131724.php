 ...
 */
class Version20190403131724 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, '19 лет Металлопрокат', '2019-04-03 12:28:13',
              '2019-04-03 12:28:13', '2019-04-03 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2019_hb_discount.html.twig')",
                array('newsletter_id' => 49),
