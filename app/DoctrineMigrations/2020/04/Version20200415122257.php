 ...
 */
class Version20200415122257 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'Металлопрокат.ру снижает цены на 30% на все услуги', '2020-04-15 12:28:13',
              '2020-04-15 12:28:13', '2020-04-15 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2019_hb_discount.html.twig')",
                array('newsletter_id' => 55),
