 ...
 */
class Version20200505111149 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'Металлопрокат.ру скидка или бонус', '2020-05-06 12:28:13',
              '2020-05-06 12:28:13', '2020-05-06 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2019_hb_discount.html.twig')",
                array('newsletter_id' => 56),
