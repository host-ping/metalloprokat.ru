 ...
 */
class Version20200820161519 extends AbstractMigration implements ContainerAwareInterface
{
       /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'ПОДКЛЮЧИТЕ ДОСТУП НА Metalloprokat.ru ДО ПОВЫШЕНИЯ ЦЕН - по mail', '2020-08-20 12:28:13',
              '2020-08-20 12:28:13', '2020-08-20 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2020_august_price_increase.html.twig')",
                array('newsletter_id' => 59),
                ...
                INSERT INTO `newsletter_recipient` (`newsletter_id`, `subscriber_id`)
                  SELECT :newsletter_id, subscribers.ID
                    ...
                    WHERE subscribers.is_invalid = false
                          ...
                          AND ( user.Email like '%mail.ru%' OR user.Email like '%list.ru%' OR user.Email like '%bk.ru%')
               ",
                array(
                    'newsletter_id' => 59,
