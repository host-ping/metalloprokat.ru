 ...
 */
class Version20170307113119 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        $this->skipIf(
            ...
            'Поздравление с 8 марта. Миграция только для металлороката.'
        );
        ...
        $this->addSql(
            "INSERT INTO newsletter (id, title, created_at, updated_at, start_at, processed_at, template)
                  ...
                  '2016-03-07 17:52:51',
                  null,
                  '@MetalProject/emails/Metalloprokat/congratulations_on_march_8.html.twig'
                  )"
        );
