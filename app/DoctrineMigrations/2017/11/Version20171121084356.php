 ...
 */
class Version20171121084356 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql(
            "INSERT INTO newsletter (id, title, created_at, updated_at, start_at, processed_at, template)
                  VALUES (
                  28,
                  'Только до 30.11.2017 Расширенный или Полный доступ с 50% скидкой!',
                  '2017-11-21 11:00:00',
                  '2017-11-21 11:00:00',
                  '2017-11-21 11:00:00',
                  null,
                  '@MetalProject/emails/Metalloprokat/metalloprokat_21_11_2017_discount.html.twig'
                  )"
        );
