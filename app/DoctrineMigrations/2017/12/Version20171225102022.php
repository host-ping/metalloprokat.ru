 ...
 */
class Version20171225102022 extends AbstractMigration implements ContainerAwareInterface
{
    /**
    ...
    public function up(Schema $schema)
    {
        ...
        if ($this->container->getParameter('project.family') === 'metalloprokat') {
            $this->addSql("
              ...
              VALUES (:newsletter_id, 'С наступающим Новым Годом и Рождеством - Металлопрокат.ру!', '2017-12-25 12:28:13',
              '2017-12-25 12:28:13', '2017-12-25 12:28:13', NULL,
              '@MetalProject/emails/Metalloprokat/metalloprokat_2018_card.html.twig')",
                array('newsletter_id' => 31),
