 ...
 */
class Version20170424133229 extends AbstractMigration implements ContainerAwareInterface
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql(
            "INSERT INTO newsletter (id, title, created_at, updated_at, start_at, processed_at, template)
                  VALUES (
                  23,
                  'Только до 10.05.2017 Расширенный или Полный доступ с 40% скидкой! ',
                  '2017-04-24 16:34:51',
                  '2017-04-24 16:34:51',
                  '2017-04-24 16:34:51',
                  null,
                  '@MetalProject/emails/Metalloprokat/metalloprokat_10_05_2017_discount.html.twig'
                  )"
        );
