...
/**
 * @ORM\Entity
 * @ORM\Table(name="content_category_closure")
 */
class CategoryClosure 
{
     ...
     * @ORM\JoinColumn(name="ancestor", referencedColumnName="id", nullable=false)
     */
    protected $ancestor;

    /**
     * @ORM\ManyToOne(targetEntity="Category")
     * @ORM\JoinColumn(name="descendant", referencedColumnName="id", nullable=false)
     */
