...
/**
 * @ORM\Entity(repositoryClass="Metal\CatalogBundle\Repository\BrandRepository")
...
class Brand
{
    ...
    /**
     * @Vich\UploadableField(mapping="brand_logo", fileNameProperty="logo.name", originalName="logo.originalName", mimeType="logo.mimeType", size="logo.size")
     * @Image(maxSize="10M")
     *
