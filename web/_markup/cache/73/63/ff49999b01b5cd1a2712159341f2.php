                ...
                <fieldset>
                    <div class=\"field-wrap\">
                        <div class=\"input-holder\">
                            ...
                            <label for=\"notice\" class=\"item-label clickable inline\">
                               <span>уведомлять на </span>
                               <a class=\"link\" href=\"#\"><strong>asdas@sadsda.ru</strong></a>
                            </label>
    ...
    <div id=\"add-content-topic\" class=\"add-content-entry-form large-popup popup-block opacity-border large\">
        <div class=\"popup-content\">
            ...
            <form id=\"add-content-topic-form\" class=\"popup-form js-ajax-form-submit\" method=\"#\">
                    ...
                    <div class=\"group clearfix\">
                        <div class=\"user-email-wrapper field-wrap float-left\">
                            <select class=\"form-select ie-radius\">
                                ...
                                <option value=\"2\">Квартира, Таунхаус</option>
                                <option value=\"3\">Загородный дом</option>
                                <option value=\"4\">Сад, строения</option>
                                <option value=\"5\">спальная</option>
                                <option value=\"6\">сауна</option>
                                <option value=\"7\">кабинет</option>
                        ...
                        <div class=\"user-email-wrapper field-wrap float-left\">
                            <select class=\"form-select ie-radius\">
                                <option value=\"1\" selected=\"selected\">Доп. категория</option>
                                <option value=\"2\">Квартира, Таунхаус</option>
                                <option value=\"3\">Загородный дом</option>
                                <option value=\"4\">Сад, строения</option>
                                <option value=\"5\">спальная</option>
                    ...
                    <div class=\"user-email-wrapper field-wrap\">
                        <select class=\"form-select ie-radius\">
                            <option value=\"1\" selected=\"selected\">Раздел</option>
                            <option value=\"2\">Проекты и технологии</option>
                            <option value=\"3\">Отделочные материалы</option>
                            <option value=\"4\">Выполнение работ</option>
                            <option value=\"5\">Мебель, декор, аксессуары</option>
                        </select>
                    </div>
                    <div class=\"textarea-wrapper field-wrap\">
